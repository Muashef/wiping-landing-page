...
export const faq = {
  ...
  accordions: [
    ...
    },
    {
      ...
      answer:
        '"Work Mode" this focuses on professional networking & matching (job seekers, recruiters, counselors, mentors & mentees) and a dating platform in "Social Mode" that matches users using our relationship algorithm and users\' preferences.',
    },
    {
